              ...
              <div className="space-y-2">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold text-muted-foreground line-through">R$ 1.245,00</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-4xl font-bold glow-cyan text-primary">R$ 622,50</p>
                    <p className="text-sm text-muted-foreground">em 12x de R$ 51,88 * no cartão</p>
                  </div>
                </div>
              </div>
